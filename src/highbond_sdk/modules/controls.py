...
class ControlsModule(PaginationMixin, ThreadingMixin):
    ...
    def delete_many(self, control_ids: List[int]) -> List[Dict[str, Any]]:
        """Exclui múltiplos controles em paralelo.
        
        Args:
            control_ids: Lista de IDs de controles a excluir.
    ...
    def link_risk(
        ...
        """Vincula um risco a um controle.
        ...
        Returns:
            Resposta da API.
        """
        endpoint = f"{self._org_endpoint}/{control_id}/relationships/risks"
        payload = {
            "data": [
    ...
    def unlink_risk(
        ...
        """Remove vínculo entre controle e risco.
        ...
        """
        endpoint = (
            f"{self._org_endpoint}/{control_id}"
    ...
    def get_risks(
        ...
        """Obtém riscos vinculados a um controle.
        ...
        """
        endpoint = f"{self._org_endpoint}/{control_id}/risks"
        params = {}
    ...
    def get_tests(
        ...
        Returns:
            Lista de testes do controle.
        """
        endpoint = f"{self._org_endpoint}/{control_id}/control_tests"
        params = {}
